...
**🌐 Live App:** [https://williamgagiano-droid.github.io/meteranalyzer/](https://williamgagiano-droid.github.io/meteranalyzer/)

## Features

- **📊 Manhattan Charts**: Every half-hourly reading shown as individual bars, color-coded by time of day
- **⚡ Energy in Watts**: See actual power consumption (not kWh)
- **💧 Water in Litres**: See actual water flow (not kL)
- **🎯 Flexible Filtering**: View half-hourly, morning (6am-12pm), afternoon (12pm-6pm), or full day
- **📈 Smart Analytics**: 
  - Peak usage identification
  - Average consumption per period
  - Variability ratios (peak vs. average)
  - Minimum and maximum usage tracking
- **🔄 Date Selection**: Drill down to specific dates
- **📍 Zero Cloud**: All data processing happens in your browser—nothing is stored
- **⚙️ Export Ready**: Screenshot charts or data for reporting
...
2. **Prepare your CSV:**
   ...
   ```
3. **Upload:** Click "Load & Visualize" and select your CSV
4. **Explore:** Switch between meters, time frames, and dates
5. **Analyze:** Use stats and averages to identify reduction opportunities
...
2. **Fix leaks** - Check for continuously running water
...
2. **Behavior changes** - Shift usage patterns
   - Shorter showers
   - Adjust thermostat 2-3°C

### Low Impact (0-10% savings)
1. **Monitor trends** - Weekly tracking for anomalies
2. **Seasonal adjustment** - Modify schedules for summer/winter
